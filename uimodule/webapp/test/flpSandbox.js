					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Liberacion de Pedidos de venta",
									"targetURL": "#Liberacion-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"Liberacion-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=godrej.liberacion",
									"url": sap.ui.require.toUrl("godrej/liberacion")
								}
							}
						}
					}
